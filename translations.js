...
const translations = {
  en: {
    ...
    promotions: "<strong>promotions</strong><br>Jintra reserves the right to offer temporary promotions, discounts, or special offers. these promotions are always temporary and do not affect the standard license terms.",
    ownership: "<strong>ownership</strong><br>Jintra retains full ownership of all beats, including licensed or exclusive beats. buyers of an exclusive license receive exclusive usage rights, but not ownership of the master or composition.",
    nonProfit: "<strong>non-profit use</strong><br>beats can be used for non-profit purposes (e.g., free releases) without purchase, provided \"Jintra\" is credited as the producer.",
    prohibitedUse: "<strong>prohibited use</strong><br>resale, sublicensing, or claiming authorship of the beat is not allowed. use in projects promoting hate, violence, or illegal activities is prohibited.",
    delivery: "<strong>delivery</strong><br>beats are delivered digitally within 24 hours of confirmed payment. contact <a href=\"mailto:hmu@jintra.nl\">hmu@jintra.nl</a> for delivery issues.",
    disputes: "<strong>disputes and refunds</strong><br>all sales are final and non-refundable. contact Jintra directly for any disputes to resolve the issue.",
    agreement: "<strong>agreement</strong><br>by purchasing or using a beat from Jintra, you agree to these terms. these terms may be updated. check <a href=\"https://terms.jintra.nl\">terms.jintra.nl</a> for the latest version.",
