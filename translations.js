...
const translations = {
  en: {
    ...
    payment: "<strong>payment</strong><br>payment methods: direct bank transfer, iDeal and PayPal. invoices are provided for every purchase. all purchases are final and non-refundable. payment must be made within 14 days of the invoice date. if the payment term is exceeded, 5% interest per month will be charged.",
