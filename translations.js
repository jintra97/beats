...
const translations = {
  en: {
    ...
    prohibitedUse: "<strong>4. prohibited use</strong><br>resale, sublicensing, or claiming authorship of the beat is not allowed. use in projects promoting hate, violence, or illegal activities is prohibited.",
